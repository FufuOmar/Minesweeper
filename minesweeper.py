...
class Sentence():
    ...
    def __init__(self, cells, count):
        self.cells = set(cells) #number of surrounding cells
        self.count = count
    ...
    def known_mines(self):
        ...
        """
        #If number of surrounding cells is equal to the number of selected cell, it means all surrounding cells are mines
    ...
    def known_safes(self):
        ...
        """
        #If number of selected cell is equal to number of flags in surrounding cells, all other cells are safe
        if self.count == 0:
            return self.cells
        return set()
